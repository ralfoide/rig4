...
public class Templater {
    ...
    private static final Pattern EXCLUDE_FROM_HASH =
            Pattern.compile("rg-excl\\(.*?\\)rg-excl", Pattern.DOTALL /* match across lines */);
    ...
    /**
     * Computes a hash of a content previous generated by {@link #generate(BaseData)}
     * whilst excluding all regions matching the EXCLUDE_FROM_HASH pattern.
     */
    public String hashContent(String generated) {
        String filtered = EXCLUDE_FROM_HASH.matcher(generated).replaceAll("");
        return DigestUtils.sha256Hex(filtered);
    }
